            ...
            <Container>
              <Row>
                <Col className="ml-auto mr-auto" md="10">
                  <h2 className="title" style={{textAlign:"center", color:"#fff"}} >FAQs </h2>
                  <br />
                    ...
                    <Row>
                      ...
                      <Col md="8">
                        <CardBody>
                          ...
                          <CardTitle tag="h3">
                            <a href="#pablo" onClick={(e) => e.preventDefault()} style={{color:"#fff"}} className="text-info">
                    ...
                    <Row>
                      <Col md="8">
                        <CardBody>
                          ...
                          <CardTitle tag="h3">
                            <a href="#pablo" onClick={(e) => e.preventDefault()} style={{color:"#fff"}} className="text-danger">
                    ...
                    <Row>
                      ...
                      <Col md="8">
                        <CardBody>
                          ...
                          <CardTitle tag="h3">
                            <a href="#pablo" onClick={(e) => e.preventDefault()} style={{color:"#fff"}} className="text-success">
                    ...
                    <Row>
                      <Col md="8">
                        <CardBody>
                          ...
                          <CardTitle tag="h3">
                            <a href="#pablo" onClick={(e) => e.preventDefault()} style={{color:"#fff"}} className="text-primary">
                    ...
                    <Row>
                      ...
                      <Col md="8">
                        <CardBody>
                          ...
                          <CardTitle tag="h3">
                            <a href="#pablo" onClick={(e) => e.preventDefault()} style={{color:"#fff"}} className="text-warning">
                    ...
                    <Row>
                      <Col md="8">
                        <CardBody>
                          ...
                          <CardTitle tag="h3">
                            <a href="#pablo" onClick={(e) => e.preventDefault()} style={{color:"#fff"}} className="text-neutral">
