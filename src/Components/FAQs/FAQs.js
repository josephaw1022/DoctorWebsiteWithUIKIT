            ...
            <Container>
              <Row>
                <Col className="ml-auto mr-auto" md="10">
                  ...
                  <h1 className="title" style={{textAlign:"center", color:"#fff", fontWeight:"bolder", marginBottom:"70px"}} >
