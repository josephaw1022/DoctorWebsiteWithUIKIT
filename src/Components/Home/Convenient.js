                      ...
                      >
                        <CardBody>
                          ...
                          <p className="card-description">
                            If you live in the Bluffton area and would like in
                            person couneseling, then in person counseling is a
                            perfect and conveinent option{" "}
                          </p>
                        </CardBody>
                      </ScrollAnimation>
                    </Col>
                    ...
                    <Col md="7">
                      ...
                      >
                        <CardBody>
                          ...
                          <p className="card-description">
                            If you live in South Carolina and would like to talk
                            to a therapist, then virtual meetings are a perfect
                            choice. Calls are conducted via Zoom, Google Meets,
                            and or FaceTime.{" "}
                          </p>
                        </CardBody>
                      </ScrollAnimation>
