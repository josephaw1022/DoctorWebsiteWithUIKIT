              ...
              <Row>
                ...
                <Col md="8">
                  <CardBody>
                    ...
                    <p className="card-description">blah blah blah blah</p>
                  </CardBody>
                </Col>
              </Row>
            </Card>
                ...
                <Col md="8">
                  <CardBody>
                    ...
                    <p className="card-description">
                      ...
                      Emmy nominations – another indicator of the shift in how
                      today’s consumers are watching TV. HBO, which has been
                      available.{" "}
                    </p>
                  </CardBody>
                </Col>
